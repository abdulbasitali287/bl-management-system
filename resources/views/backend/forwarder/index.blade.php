...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-end py-3">
        <a href="{{ route('forwarder.create') }}" class="btn btn-sm btn-dark px-3 me-2">Create</a>
        <a href="{{ route('forwarder.trashed') }}" class="btn btn-sm btn-danger px-3">Trashed</a>
    </div>
        ...
        <tbody>
            @if (count($data) > 0)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('forwarder.edit', $item->fid) }}" class="btn btn-sm btn-success mx-1">Edit</a>
                                {!! Form::open(['url' => route('forwarder.trash',$item->fid),'method' => 'delete']) !!}
