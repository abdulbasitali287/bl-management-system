...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            <form action="{{ route('forwarder.store') }}" method="POST">
                @csrf
                <div class="form-group my-3">
                    {!! Form::label("", "Forwarder Name", ["class" => "py-2"]) !!}
                ...
                <div class="form-group my-2">
                    ...
                    <a href="{{ route('forwarder.index') }}" class="text-decoration-none btn btn-sm btn-primary mx-2 px-2">Back</a>
                </div>
            </form>
        </div>
    </div>
