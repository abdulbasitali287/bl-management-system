...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-end py-3">
        <a href="{{ route('shipper.create') }}" class="btn btn-sm btn-dark px-3 me-2">Create</a>
        <a href="{{ route('shipper.trashed') }}" class="btn btn-sm btn-danger px-3">Trashed</a>
    </div>
        ...
        <tbody>
            @if (count($data) > 0)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('shipper.edit', $item->shipper_id) }}" class="btn btn-sm btn-success mx-1">Edit</a>
                                {!! Form::open(['url' => route('shipper.trash',$item->shipper_id),'method' => 'delete']) !!}
